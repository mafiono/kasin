...
import { deposittransactionHistoryLoad,pagenationchange} from "../../../../../redux/actions/paymentGateWay"
...
class DepositStatusChild extends Component {
    ...
    state = {
     ...
     componentDidMount(){
      this.props.deposittransactionHistoryLoad( { start: this.state.date[0],end: this.state.date[1],},this.props.parsedFilter)
    }
    ...
    date_change = async (e) =>{
      if(e.length === 2){
        ...
        this.props.deposittransactionHistoryLoad({
...
export default connect(mapStateToProps, {deposittransactionHistoryLoad,pagenationchange})(DepositStatusChild)