        ...
        return (
            <Row className='p-2'>
                ...
                <Col sm='12' lg='6' className='pl-1 pr-1'>
                    ...
                    <Row  className='mt-1 pt-1'>
                        <Col xs='12'>
                            <Button className='igamez-button' color="warning" onClick={paymentWithdraw} style={{width:'100%',fontWeight:'bold'}}>Make withdraw</Button>
                        </Col>
                    </Row>
                </Col>
                <Col xs='12'>
                        ...
                        <Col xs='12' sm='6' className='mt-2'>
                            ...
                            {state.moreInfoState?(
                                <Row className='payment-deposit-text font-2 mt-1'>
                                    <Col xs='12'><Input style={{minHeight:'300px', borderRadius:'0px'}} type='textarea' value={state.activeMethod.info} /></Col>
                                </Row>
                            ):null}
                        </Col>
                        <Col xs='12' sm='6'></Col>
