...
class Casino extends React.Component {
  ...
  componentDidMount(){
    this.props.data_load(providerconfig["CASINO/SLOTS"],"1","CASINOSLIDERIMGS");
  ...
  typesActive = value => {
    this.props.gametypechange(value,providerconfig["CASINO/SLOTS"])
  }

  provider_change = value =>{ 
    this.props.providerchange(value,providerconfig["CASINO/SLOTS"])
  }
  render() {
