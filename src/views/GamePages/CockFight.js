...
class Casino extends React.Component {
  ...
  componentDidMount(){
    this.props.data_load(providerconfig["COCKFIGHT"],"8","COCKFIGHTSLIDERIMGS");
  ...
  typesActive = value => {
    this.props.gametypechange(value,providerconfig.COCKFIGHT)
  }

  provider_change = value =>{
      this.props.providerchange(value,providerconfig.COCKFIGHT)
  }
...
const get_game  = (state) =>{
    ...
    return { 
      ...
      casinoSlider_images : state.auth.login.cockfight_images,
