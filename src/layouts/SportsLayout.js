...
import ExchgSidebar from "../views/Exchg/BetSidebar";
    ...
    return (
      ...
      <style dangerouslySetInnerHTML={{__html: `
        ...
        >
          <Navbar {...navbarProps} />
          {
            history.location.pathname === "/Satta/pages" || history.location.pathname === "/Satta/bazar" ? 
            <SattaSiderbar /> 
             : 
            (
              history.location.pathname === "/exchg" || history.location.pathname === "/exchgevent" ? 
              <ExchgSidebar/> 
               :
              <BetSidebar/> 
            )
          ...
          {/* {
            this.state.currRoute === "Satta/event" || this.state.currRoute === "/Satta/pages" ? 
          } */}
