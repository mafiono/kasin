...
class SideMenuContent extends React.Component {
  ...
  get_groups_active = (id) =>{
    let open_group = [];
    let sidebar = this.props.FirstPage.sidebar
    var s_item =  get_item(id,sidebar);
  ...
  render() {
    const {sidebar} = this.props.FirstPage
    // Loop over sidebar items
    // eslint-disable-next-line
    let navigationConfig =  sidebar;
